...
function DocumentPage({ data }) {
    ...
    while (markup.includes("<figure>")) {
        ...
        markup = markup.replace(figureHTML, `<img src="${url}" alt="Изображение">`);
    }
        ...
        <article className={styles.document}>
            <div className={styles.document__wrapper}>
                ...
                {data.attributes.isAnnouncement &&
                    <div className={styles.category__yellow}>
                        <span>Анонсы и календарные события</span>
                    </div>
                }

                {data.attributes.isDigest &&
                    <div className={styles.category__yellow}>
                        <span>Сводка новостей</span>
                    </div>
                }
                ...
                <div className={styles.footer}>
                    ...
                    <a href={data.url} target="_blank" rel="noreferrer">
                        <span className={styles.sourceName}>Читать в источнике</span>
                    </a>
                     </button>
